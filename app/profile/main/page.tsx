...
export default async function ProfileScreen() {
  ...
  const orders = JSON.parse(JSON.stringify(orderDocs));
    ...
    // Aggregate sales for the current year only
    ...
    const formattedSales = (ordersPriceGroup[0]?.sales || 0) / 100;
  /* END */
  /* ACTUALS */
    ...
    return (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="rounded-[12px]">
          ...
          <TreeMap productsData={productsData}/>
        </div>
        <div className=" rounded-[12px]">
        ...
        <div className="col-span-1 sm:col-span-2  rounded-[12px]">
